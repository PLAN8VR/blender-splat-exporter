...
There is a slider for global opacity and size of splat, and an autosize splats option based on neareast point relative proximity (Be sure to apply any scaling as it effects the autoscale results). 
